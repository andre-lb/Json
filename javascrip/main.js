...
function insereLinha(id, nome,nota, site,endereco,telefone){
    let linha = '<tr>' +
                    '<td class="col-xs-2">' + 
                        '<a href="#" class="action_edit" value="'+ id +'"><img src="img/editar.jpeg" /></a>' +
                        '<a href="#" class="action_delete" value="'+ id +'"><img src="img/excluir.jpeg" /></a>' +
                    '</td>' +
                    ...
                    '<td id=\enderecoIdTb\' class="col-xs-8">'+
                        endereco +
                    '</td>' +
                    '<td id=\telefoneIdTb\' class="col-xs-4">' +
                        telefone +
                    '</td>' +
                '</tr>';
